...
2. Clone this repo 
```
git clone https://github.com/tjay1760/hello-rails-back-end.git
```
...
Greeting.create(content: "Holla")
# Create the second greeting
Greeting.create(content: "Bojour")
# Create the third greeting
Greeting.create(content: "Como estas")
# Create the fourth greeting
Greeting.create(content: "Greetings")
# Create the fifth greeting
Greeting.create(content: "Jambo")
```
